...
class AuthControllerTests {
    ...
    final UserAccount existingUserAccount = new UserAccount(null, "username", "encryptionSalt", true);
    final UserAccount encodedAccount = new UserAccount(null, "username", "encryptionSalt", true);
    final UserAccount encodedAccountDiffPswd = new UserAccount(null, "username", "encryptionSalt", true);

    String encryptionKeySalt = "encryptionSalt";
...
//                        .content(objectMapper.writeValueAsString(encryptionKeySalt)))
